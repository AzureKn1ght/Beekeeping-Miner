const abi = [
  {
    inputs: [{ internalType: "address", name: "_token_BUSD", type: "address" }],
  ...
  {
    inputs: [],
    name: "MARKET_HONEY_DIVISOR_SELL",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "SET_COMPOUNDS_FOR_NO_TAX_WITHDRAWAL",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "value", type: "uint256" }],
    name: "SET_HONEY_TO_BUILD_A_HIVE",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "value", type: "uint256" }],
    name: "SET_PENALTY_WITHDRAWAL_TAX",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "calculateHoneyBuySimple",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "uint256", name: "honey", type: "uint256" }],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "honey", type: "uint256" },
      { internalType: "uint256", name: "amount", type: "uint256" },
    ],
    name: "calculateHoneySellForYield",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "getHoneySinceLastCompound",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "_totalCompounded", type: "uint256" },
      { internalType: "uint256", name: "_totalRefRewards", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "_compoundedDeposit", type: "uint256" },
      { internalType: "uint256", name: "_hives", type: "uint256" },
      { internalType: "uint256", name: "_honey", type: "uint256" },
      {
        internalType: "uint256",
        name: "_lastCompoundTimestamp",
        type: "uint256",
      },
      ...
      { internalType: "uint256", name: "_compounds", type: "uint256" },
      {
        internalType: "uint256",
        name: "_lastWithdrawTimestamp",
        type: "uint256",
      },
    ],
    stateMutability: "view",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "compoundedDeposit", type: "uint256" },
      { internalType: "uint256", name: "hives", type: "uint256" },
      { internalType: "uint256", name: "honey", type: "uint256" },
      {
        internalType: "uint256",
      ...
      { internalType: "uint256", name: "referralReward", type: "uint256" },
